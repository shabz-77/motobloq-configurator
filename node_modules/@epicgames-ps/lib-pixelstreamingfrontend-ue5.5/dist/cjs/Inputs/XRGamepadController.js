...
exports.XRGamepadController = void 0;
    ...
    updateStatus(source, frame, refSpace) {
        if (source.gamepad) {
            ...
            if (this.controllers[handedness] === undefined) {
                ...
                this.controllers[handedness].prevState = (0, GamepadTypes_1.deepCopyGamepad)(source.gamepad);
            }
            this.controllers[handedness].currentState = (0, GamepadTypes_1.deepCopyGamepad)(source.gamepad);
...
exports.XRGamepadController = XRGamepadController;
