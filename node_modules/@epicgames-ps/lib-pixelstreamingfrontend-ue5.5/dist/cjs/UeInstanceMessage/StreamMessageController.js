...
exports.MessageDirection = exports.StreamMessageController = exports.ToStreamerMessage = void 0;
const lib_pixelstreamingcommon_ue5_5_1 = require("@epicgames-ps/lib-pixelstreamingcommon-ue5.5");
class ToStreamerMessage {
}
exports.ToStreamerMessage = ToStreamerMessage;
    ...
    registerMessageHandler(messageDirection, messageType, messageHandler) {
        switch (messageDirection) {
            ...
            case MessageDirection.FromStreamer:
                ...
                break;
            default:
                lib_pixelstreamingcommon_ue5_5_1.Logger.Info(`Unknown message direction ${messageDirection}`);
        }
    }
}
exports.StreamMessageController = StreamMessageController;
/**
