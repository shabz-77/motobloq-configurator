...
exports.DataChannelController = void 0;
...
class DataChannelController {
    ...
    handleOnOpen(ev) {
        var _a;
        lib_pixelstreamingcommon_ue5_5_1.Logger.Info(`Data Channel (${this.label}) opened.`);
    ...
    handleOnClose(ev) {
        var _a;
        lib_pixelstreamingcommon_ue5_5_1.Logger.Info(`Data Channel (${this.label}) closed.`);
    ...
    handleOnMessage(event) {
        ...
        lib_pixelstreamingcommon_ue5_5_1.Logger.Info(`Data Channel (${this.label}) message: ${event}`);
    }
    /**
    ...
    handleOnError(event) {
        var _a;
        lib_pixelstreamingcommon_ue5_5_1.Logger.Info(`Data Channel (${this.label}) error: ${event}`);
...
exports.DataChannelController = DataChannelController;
