...
exports.FileTemplate = exports.FileUtil = void 0;
...
class FileUtil {
    ...
    static setExtensionFromBytes(view, file) {
        ...
        lib_pixelstreamingcommon_ue5_5_1.Logger.Info(extensionAsString);
    ...
    static setMimeTypeFromBytes(view, file) {
        ...
        lib_pixelstreamingcommon_ue5_5_1.Logger.Info(mimeAsString);
