...
import { PixelStreamingEventEmitter } from '../Util/EventEmitter';
/**
...
export declare class Flags {
    ...
    static UseModalForTextInput: "UseModalForTextInput";
...
export declare const isFlagId: (id: string) => id is FlagsIds;
/**
...
export declare class NumericParameters {
    ...
    static MinQP: "MinQP";
    static MaxQP: "MaxQP";
    static MinQuality: "MinQuality";
    static MaxQuality: "MaxQuality";
    static CompatQualityMin: "CompatQualityMin";
    static CompatQualityMax: "CompatQualityMax";
...
export declare const isNumericId: (id: string) => id is NumericParametersIds;
/**
...
export declare const isTextId: (id: string) => id is TextParametersIds;
/**
...
export declare class OptionParameters {
    ...
    static PreferredQuality: "PreferredQuality";
}
...
export declare const isOptionId: (id: string) => id is OptionParametersIds;
/**
...
export declare class Config {
     ...
     */
    get webSocketProtocols(): string | string[];
    /**
     ...
     * @param eventEmitter
     */
    _registerOnChangeEvents(eventEmitter: PixelStreamingEventEmitter): void;
}
/**
