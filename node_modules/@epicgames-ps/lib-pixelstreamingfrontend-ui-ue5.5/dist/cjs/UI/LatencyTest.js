...
class LatencyTest {
    ...
    get rootElement() {
        if (!this._rootElement) {
            ...
            headingText.innerHTML = UIConfigurationTypes_1.StatsSections.LatencyTest;
    ...
    handleTestResult(latencyTimings) {
        lib_pixelstreamingfrontend_ue5_5_1.Logger.Info(JSON.stringify(latencyTimings));
