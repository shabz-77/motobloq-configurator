...
exports.PlayOverlay = void 0;
const ActionOverlay_1 = require("./ActionOverlay");
/**
 * Overlay shown when stream is ready to play.
 */
class PlayOverlay extends ActionOverlay_1.ActionOverlay {
    /**
...
exports.PlayOverlay = PlayOverlay;
