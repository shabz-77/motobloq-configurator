...
exports.PixelStreamingApplicationStyle = void 0;
const jss_1 = __importDefault(require("jss"));
const jss_plugin_global_1 = __importDefault(require("jss-plugin-global"));
...
class PixelStreamingApplicationStyle {
    constructor(options) {
        ...
        const jssOptions = {
            ...
            plugins: [(0, jss_plugin_global_1.default)(), (0, jss_plugin_camel_case_1.default)()],
            insertionPoint: jssInsertionPoint
        };
        jss_1.default.setup(jssOptions);
    ...
    applyStyleSheet() {
        ...
        jss_1.default.createStyleSheet({
...
exports.PixelStreamingApplicationStyle = PixelStreamingApplicationStyle;
